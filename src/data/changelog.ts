...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    descKey: "changelog.entries.easierNav.desc",
  },
  {

    id: "2026-09-21-free-tools",
    date: "2026-09-21",
    titleKey: "changelog.entries.freeTools.title",
    descKey: "changelog.entries.freeTools.desc",
  },
  {
    id: "2026-09-20-fix-pass",
    date: "2026-09-20",
    titleKey: "changelog.entries.fixPass.title",
    descKey: "changelog.entries.fixPass.desc",
  },
  {
    id: "2026-09-12-site-watch",
    date: "2026-09-12",
    titleKey: "changelog.entries.siteWatch.title",
    descKey: "changelog.entries.siteWatch.desc",
  },
  {
    id: "2026-09-09-free-first-audit",
    date: "2026-09-09",
    titleKey: "changelog.entries.freeFirstAudit.title",
    descKey: "changelog.entries.freeFirstAudit.desc",
  },
  {
    id: "2026-09-03-more-languages",
    date: "2026-09-03",
    titleKey: "changelog.entries.moreLanguages.title",
    descKey: "changelog.entries.moreLanguages.desc",
  },
  {
